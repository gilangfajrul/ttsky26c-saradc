...
N 580 -100 580 -80 {lab=0}
N 110 -150 140 -150 {lab=clk}
N 110 -200 110 -150 {lab=clk}
N 220 -150 230 -150 {lab=clkb}
N 230 -190 230 -150 {lab=clkb}
N 490 -240 580 -240 {lab=vout}
N 580 -180 580 -160 {lab=#net1}
N 540 -110 540 -90 {lab=0}
N 540 -90 580 -90 {lab=0}
...
C {vsource.sym} 70 -210 0 0 {name=Vin value="DC 0.9" savecurrent=false}
C {gnd.sym} 70 -180 0 0 {name=l3 lab=0}
C {gnd.sym} 580 -80 0 0 {name=l5 lab=0}
...
C {code.sym} 840 -250 0 0 {name=ngspice only_toplevel=false value="
.ic v(vout)=0
.control
 set filetype = ascii
 set wr_vecnames
 ...
 let drv1_vds = v(xbootstrap.vgate) - v(xbootstrap.net1)
 let drv2_vds = v(xbootstrap.net1)
 ...
 write tb1_track_hold.raw v(vin) v(vout) v(clk) v(clkb) v(xbootstrap.vgate) v(xbootstrap.ctop) v(xbootstrap.cbot) v(xbootstrap.vgdistop) v(xbootstrap.net1)
...
spice_ignore=false
place=header}
C {vcvs.sym} 580 -130 0 0 {name=Eb value=1}
C {vsource.sym} 580 -210 2 0 {name=Vdb value=50m savecurrent=false}
C {lab_pin.sym} 540 -150 0 0 {name=p6 sig_type=std_logic lab=vin}
