...
C {lab_pin.sym} 340 -520 0 0 {name=p1 sig_type=std_logic lab=clks}
...
C {lab_pin.sym} 640 -420 2 0 {name=p2 sig_type=std_logic lab=vdd}
C {gnd.sym} 640 -400 0 0 {name=l1 lab=0}
C {lab_pin.sym} 840 -390 2 1 {name=p7 sig_type=std_logic lab=vip}
C {lab_pin.sym} 540 -300 0 0 {name=p8 sig_type=std_logic lab=vip}
C {lab_pin.sym} 540 -320 0 0 {name=p9 sig_type=std_logic lab=vin}
C {simulator_commands.sym} 890 -580 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
.include /foss/designs/ttsky26c-saradc/pex/tt_um_gilangfajrul_sar_adc.pex.spice
.control
 remzerovec
...
spice_ignore=false
place=header}
C {lab_pin.sym} 640 -440 2 0 {name=p10 sig_type=std_logic lab=D[0..7]}
...
C {lab_pin.sym} 540 -340 2 1 {name=p14 sig_type=std_logic lab=EOC}
C {lab_pin.sym} 640 -520 2 0 {name=p3 sig_type=std_logic lab=ua[0:1]}
C {lab_pin.sym} 540 -320 2 0 {name=p5 sig_type=std_logic lab=ua[1]}
C {lab_pin.sym} 540 -300 2 0 {name=p11 sig_type=std_logic lab=ua[0]}
C {tt_um_gilangfajrul_sar_adc_pex.sym} 490 -460 0 0 {name=x1}
C {lab_pin.sym} 640 -460 2 0 {name=p13 sig_type=std_logic lab=uio_out[0:7]}
C {lab_pin.sym} 540 -340 2 0 {name=p15 sig_type=std_logic lab=uio_out[0]}
